...
@section('content')
    <a href="/projects/{{ $project->id }}" class="py-1 px-4 border rounded-full hover:bg-gray-200 transition "> ⬅ Go Back</a>
    <div class="flex justify-center">
        <div class="bg-white shadow-md rounded-lg overflow-hidden w-full md:w-8/12 lg:w-6/12">
            <h2 class="py-4 px-6 bg-teal-500 text-white border-b font-medium">
                Report a new Bug in - {{ $project->title }}
            </h2>
            ...
            <div class="px-6 py-4">
                <form method="POST" action="{{ route('bugs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="title" type="text" placeholder="Your Bug title here..."
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" cols="30" rows="4"
                            ...
                            class="mt-1 block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500"></textarea>
                    </div>
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="assigntodev" class="block text-sm font-medium text-gray-700">
                                Assign to - select a developer
                            </label>
                    ...
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="bugstatus" id="bugstatus" disabled
